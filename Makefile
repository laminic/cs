cs: inout.o login.o auth.o user.o user_mod.o material.o material_mod.o main.o init_db.o
	gcc -o cs inout.o login.o auth.o user.o user_mod.o material.o material_mod.o main.o init_db.o -lsqlite3 `pkg-config --cflags --libs gtk+-3.0 gmodule-export-2.0`
...
inout.o: inout.c inout.h
	gcc -g -c inout.c `pkg-config --cflags --libs gtk+-3.0 gmodule-export-2.0`
